...
class Tasks extends Object
{
    ...
    {
        // delete list
        $result = $this->api->doCall('tasks/:' . $taskId, null, 'DELETE');
    ...
    {
        return $this->api->doCall('tasks/:' . $taskId);
    }
    ...
    public function insert(
        ...
        // return insert task
        return $this->api->doCall('tasks', $parameters, 'POST');
    }
}
